...
SUPABASE_KEY = os.environ.get(
    "SUPABASE_KEY",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9pbWxhbWppbGl2cmNuaHp0d3ZqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE1NDAzNzksImV4cCI6MjA4NzExNjM3OX0.n1_ABkUUoq1txhw3dUcqFlbFM1gh6fNjCI45L7BAmHE",
)
HEADERS = {
    "apikey": SUPABASE_KEY,
